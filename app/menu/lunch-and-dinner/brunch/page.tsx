...
import { allergenNotice, brunchMenu } from "@/lib/site-data"
  ...
  return (
    <main className="mx-auto flex max-w-5xl flex-col gap-10 px-6 py-16">
      <PageHeader
        ...
        title="Sunday brunch, 11 AM - 3 PM"
        description="Brunch shareables, hearty plates, and libations only at the Northside location."
      />

      <div className="grid gap-6">
        {brunchMenu.map((category) => (
