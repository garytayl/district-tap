      ...
      <section className="relative overflow-hidden bg-black text-white">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-6 py-24">
          <div className="max-w-2xl space-y-6">
            <p className="site-intro-headline text-3xl font-semibold text-white sm:text-4xl">
              Hungry?
            </p>
            <div className="site-intro-rest space-y-6">
          ...
          <div className="site-intro-rest grid gap-6 md:grid-cols-2">
