...
export default function NorthsideApplicationPage() {
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-10 px-6 py-16">
      <PageHeader
        eyebrow="Northside Application"
        title="Apply to The District Tap Northside"
        description="Complete the application below and our team will be in touch."
      />
